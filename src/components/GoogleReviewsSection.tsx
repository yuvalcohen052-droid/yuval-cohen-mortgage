...
const reviews = [
  ...
  {
    name: "שרון כ.",
    text: "יובל ליווה אותנו מהרגע הראשון ועד החתימה. הרגשנו בטוחים לאורך כל הדרך. מומלץ בחום!",
    time: "לפני שבוע",
  },
  {
    name: "מיכאל ונעמה ש.",
    text: "הצליח להוריד לנו ריבית משמעותית על מיחזור המשכנתא. חסכנו מאות שקלים בחודש!",
    time: "לפני 2 שבועות",
  },
  {
    name: "רותם ד.",
    text: "יועץ משכנתאות מספר 1. ידע מקצועי, יחס אישי ותוצאות מעולות. תודה יובל!",
    time: "לפני 4 חודשים",
  },
];
...
function ReviewCard({ review }: { review: (typeof reviews)[0] }) {
  ...
  return (
    <div className="bg-card rounded-xl p-5 shadow-sm border border-border min-w-[300px] md:min-w-0 snap-center flex-shrink-0">
...
export default function GoogleReviewsSection() {
  ...
  return (
    <section id="reviews" className="bg-slate-bg py-20">
