...
const pillars = [
  {
    ...
    text: "בניית תמהיל משכנתא מדויק בהתאם למצב הכלכלי שלכם כיום ולתכניות הפיננסיות שלכם לעתיד.",
  },
  {
    icon: Swords,
    iconKey: "Swords",
    title: "כוח מיקוח אגרסיבי",
    text: "ניהול משא ומתן מול הבנקים במטרה להשיג עבורכם תנאי מימון וריביות תחרותיות.",
  },
  {
    icon: KeyRound,
    iconKey: "KeyRound",
