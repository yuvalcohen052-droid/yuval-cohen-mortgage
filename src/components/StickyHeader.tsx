        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="אינסטגרם"
              className="w-8 h-8 flex items-center justify-center rounded-full bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#bc1888] text-white hover:scale-110 transition-transform"
            >
              <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
