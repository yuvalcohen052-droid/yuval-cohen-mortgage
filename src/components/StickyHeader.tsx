        ...
        <nav aria-label="תפריט ניווט נייד" className="md:hidden fixed inset-0 top-0 bg-white z-40 flex flex-col">
          ...
          <div className="flex items-center justify-center gap-4 mb-6">
            <a
              ...
              aria-label="וואטסאפ"
              className="w-12 h-12 flex items-center justify-center rounded-full bg-[#25D366] text-white hover:scale-110 transition-transform"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="אינסטגרם"
              className="w-12 h-12 flex items-center justify-center rounded-full bg-gradient-to-br from-[#f09433] via-[#e6683c] to-[#bc1888] text-white hover:scale-110 transition-transform"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="טיקטוק"
              className="w-12 h-12 flex items-center justify-center rounded-full bg-black text-white hover:scale-110 transition-transform"
            >
            ...
            <a
              ...
              rel="noopener noreferrer"
              aria-label="פייסבוק"
              className="w-12 h-12 flex items-center justify-center rounded-full bg-[#1877F2] text-white hover:scale-110 transition-transform"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
